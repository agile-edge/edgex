...
hosted in the [EdgeX Foundry Organization](https://github.com/agile-edge) on GitHub.
...
list](https://github.com/agile-edge/edgex/issues) to determine whether it already include the
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure
   ...
   git remote add upstream https://github.com/agile-edge/edgex.git
   ```

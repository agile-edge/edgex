...
import (
	errors "github.com/agile-edge/go-mod-core-contracts/v4/errors"

	mock "github.com/stretchr/testify/mock"

	models "github.com/agile-edge/go-mod-core-contracts/v4/models"

	requests "github.com/agile-edge/go-mod-core-contracts/v4/dtos/requests"
)
...
func (_m *DBClient) NotificationCountByCategoriesAndLabels(categories []string, labels []string, ack string) (uint32, errors.EdgeX) {
	...
	var r0 uint32
	var r1 errors.EdgeX
	if rf, ok := ret.Get(0).(func([]string, []string, string) (uint32, errors.EdgeX)); ok {
		return rf(categories, labels, ack)
	}
	if rf, ok := ret.Get(0).(func([]string, []string, string) uint32); ok {
...
func (_m *DBClient) NotificationCountByCategory(category string, ack string) (uint32, errors.EdgeX) {
...
func (_m *DBClient) NotificationCountByLabel(label string, ack string) (uint32, errors.EdgeX) {
...
func (_m *DBClient) NotificationCountByQueryConditions(condition requests.NotificationQueryCondition, ack string) (uint32, errors.EdgeX) {
	...
	var r0 uint32
	var r1 errors.EdgeX
	if rf, ok := ret.Get(0).(func(requests.NotificationQueryCondition, string) (uint32, errors.EdgeX)); ok {
		return rf(condition, ack)
	}
	if rf, ok := ret.Get(0).(func(requests.NotificationQueryCondition, string) uint32); ok {
		r0 = rf(condition, ack)
	} else {
		r0 = ret.Get(0).(uint32)
	}
...
func (_m *DBClient) NotificationCountByStatus(status string, ack string) (uint32, errors.EdgeX) {
...
func (_m *DBClient) NotificationCountByTimeRange(start int64, end int64, ack string) (uint32, errors.EdgeX) {
	...
	var r0 uint32
	var r1 errors.EdgeX
	if rf, ok := ret.Get(0).(func(int64, int64, string) (uint32, errors.EdgeX)); ok {
		return rf(start, end, ack)
	}
	if rf, ok := ret.Get(0).(func(int64, int64, string) uint32); ok {
		r0 = rf(start, end, ack)
	} else {
		r0 = ret.Get(0).(uint32)
	}
